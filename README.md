...
pip install cgg
```
If your c/c++ compiler cannot build the engine wheel successfully; opt to get it [here](https://github.com/abetlen/llama-cpp-python/releases) straight; or could try gguf-core.
